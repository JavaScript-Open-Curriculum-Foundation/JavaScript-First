...
export default function SubscribeBTN() {
  ...
  if (!isToggled) {
    return (
      <div className="subscribedBTNgroup" >
      <button className="defaultStyle" onClick={toggleTrueFalse}>
        <h3>Subscribe</h3>
      </button>
    </div>
    );
  ...
  return (
    <>
    <div className="subscribedBTNgroup">
      <button className="btnActiveStyle" onClick={toggleTrueFalse}>
        <h3>Subscribed</h3>
      </button>
...
export const IconBell = (props) =>  {
  ...
  return (
    <div onClick={toggleALL} >
      <svg xmlns="http://www.w3.org/2000/svg" className="subscribedIcon" viewBox={viewBox} 
